...
public class SlideOnScaleAndeAlphaAdapter extends AnimationAdapter {
    public SlideOnScaleAndeAlphaAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        super(adapter);
    }
    ...
    protected Animator[] getAnimators(View view) {
        return new Animator[]{
                ObjectAnimator.ofFloat(view, "scaleX", 0.3f,1.0f),
                ObjectAnimator.ofFloat(view, "scaleY", 0.3f,1.0f),
