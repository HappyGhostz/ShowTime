...
public class Constant {
    ...
    public static String PATH_DATA = FileUtils.createRootPath(App.getAppContext()) + "/cache";

    public static String PATH_COLLECT = FileUtils.createRootPath(App.getAppContext()) + "/collect";
    ...
    public static String BASE_PATH = App.getAppContext().getCacheDir().getPath();
