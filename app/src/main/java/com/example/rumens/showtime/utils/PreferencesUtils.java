...
public class PreferencesUtils {
    ...
    public static String getSavePath(Context context) {
        return getString(context, ConstantUitles.SET_SAVE_PATH_KEY, ConstantUitles.SET_DEFAULT_SAVE_PATH);
    }
    ...
    public static boolean isShowImageAlways(Context context) {
        return getBoolean(context, ConstantUitles.SET_NO_IMAGE_KEY, false);
    }
