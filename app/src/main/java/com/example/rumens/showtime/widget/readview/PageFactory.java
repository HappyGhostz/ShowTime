...
public class PageFactory {
    ...
    private List<BookMixATocBean.mixToc.Chapters> chaptersList;
    ...
    public PageFactory(Context context, String bookId, List<BookMixATocBean.mixToc.Chapters> chaptersList) {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
                       List<BookMixATocBean.mixToc.Chapters> chaptersList) {
        mContext = context;
        mWidth = width;
        mHeight = height;
        mFontSize = fontSize;
        ...
        mTitlePaint.setColor(ContextCompat.getColor(App.getAppContext(), R.color.chapter_title_day));
